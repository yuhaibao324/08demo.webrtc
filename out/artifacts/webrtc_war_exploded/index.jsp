	...
	<body ondblclick="fullScreen()">
		...
		<script type="text/javascript">
			...
			function openChannel() {
				...
				socket = new WebSocket("ws://192.168.1.100:8080/webrtc/acgist.video/${requestScope.uid}");
			...
			function noticeMsg() {
				if (!initiator) {
					setNotice("让别人加入（注意事项查看源码）: http://192.168.1.100:8080/webrtc/msg?oid=${requestScope.uid }");
				} else {
					setNotice("初始化...");
				}
			}
